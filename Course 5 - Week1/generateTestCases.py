...
by = np.random.randn(2, 1)
parameters2 = {"Wf": Wf, "Wi": Wi, "Wo": Wo, "Wc": Wc,
               "Wy": Wy, "bf": bf, "bi": bi, "bo": bo, "bc": bc, "by": by}
a_next_lstm, c_next_lstm, yt_lstm, cache_lstm = lstm_cell_forward(
    xt1, a_prev1, c_prev1, parameters2)
...
parameters3 = {"Wf": Wf, "Wi": Wi, "Wo": Wo, "Wc": Wc,
               "Wy": Wy, "bf": bf, "bi": bi, "bo": bo, "bc": bc, "by": by}
